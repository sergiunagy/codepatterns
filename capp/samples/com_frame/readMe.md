# Snapshot of the comFramework project

 This snapshot serves the purpose of providing COM (here CAN bus) stack implementation files.
 It also contains sample dbc files that can be adjusted.
 The project is open source and the official repository is here:
 - https://sourceforge.net/projects/comframe/

See below for the associated repository readme.
...
related new sample has been added. Text fields of the data model can be
compared with one another or with expected contents or they can be matched
